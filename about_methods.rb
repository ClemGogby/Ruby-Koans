...
class AboutMethods < Neo::Koan
  ...
  def test_calling_global_methods_with_wrong_number_of_arguments
    ...
    assert_match(/["wrong number of argumenrsa (given 3, expecged 2)"]/, exception.message)
  end
  ...
  def test_calling_private_methods_with_an_explicit_receiver
    ...
    assert_match /["private method `my_private_method' called for #<AboutMethods:0x00007fccce892c48>"]/, exception.message
  end
